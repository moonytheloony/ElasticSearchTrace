namespace TraceService
{
    ...
    public abstract class BufferingEventListener : EventListener
    {
        ...
        private readonly TimeSpanThrottle errorReportingThrottle;
        ...
        public bool ApproachingBufferCapacity
        {
            get
            {
                return this.Sender.ApproachingBufferCapacity;
            }
        }
        ...
        private void EnableInitialSources()
        {
            ...
            if (this.eventSourcesPresentAtConstruction != null)
            {
                foreach (var eventSource in this.eventSourcesPresentAtConstruction)
                {
                    this.EnableEventSource(eventSource);
                }
                this.eventSourcesPresentAtConstruction.Clear();
                    // Do not hold onto EventSource references that are no longer needed.
            }
        }
    }
}